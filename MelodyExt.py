...
if __name__ == "__main__":
    # infile = '/Users/LEE/PycharmProjects/devocal_v2/vocal/perfect/74259_64335_擊敗人_42750199.mp3'
    infile = '/Users/LEE/PycharmProjects/devocal_v2/vocal/perfect/89170.wav'
    # infile = "89170.wav"
    outfile = 'out_good'
    result, postgram, Z, tfrL0, tfrLF, tfrLQ, t, CenFreq = melody_extraction(infile, outfile)

    # np.savetxt("result.txt", result)
    # np.savetxt("postgram.txt", postgram)

    import matplotlib.pyplot as plt

    plt.imshow(postgram[:, 5000:7000], aspect='auto')
    plt.show()
